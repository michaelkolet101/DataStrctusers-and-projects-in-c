...
{
    /*
    1. Defines a variable i = 0 
        We define a new memory = memory
    ...
    5. The member who represents the top of the list in the .
        structure will point to the first free Icades which is Incodes 0
    */
}
...
void *FSPoolAlloc(fsp_ty *fs_pool)
{
    ...
    3. If yes then the pointer for the return value 
                            will point to the first available index.
